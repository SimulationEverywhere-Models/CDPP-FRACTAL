...
rule : { 2 + random } 20 { (trunc((0,0)) = 2) AND (CELLPOS(0) = 0)  AND (0     <= fractional((0,0))) AND (fractional((0,0)) < 0.25) }
rule : { 2 + random } 20 { (trunc((0,0)) = 2) AND (CELLPOS(1) = 0)  AND (0.25 <= fractional((0,0))) AND (fractional((0,0)) < 0.5)  }
rule : { 2 + random } 20 { (trunc((0,0)) = 2) AND (CELLPOS(1) = 15) AND (0.5  <= fractional((0,0))) AND (fractional((0,0)) < 0.75) }

rule : { 1 + send(new_particle,1) } 20 { ((0,0) = 0) AND (trunc((1,0))  = 2) AND (0     <= fractional((1,0)))  AND (fractional((1,0))  < 0.25) AND (CELLPOS(0) != 14) AND ( ((-1,-1) = 1) OR ((-1,0) = 1) OR ((-1,1) = 1) OR ((0,-1) = 1) OR ((0,1) = 1) OR ((1,-1) = 1) OR ((1,0) = 1) OR ((1,1) = 1) ) }
rule : { 1 + send(new_particle,1) } 20 { ((0,0) = 0) AND (trunc((0,1))  = 2) AND (0.25 <= fractional((0,1)))  AND (fractional((0,1))  < 0.5 ) AND (CELLPOS(0) != 15) AND ( ((-1,-1) = 1) OR ((-1,0) = 1) OR ((-1,1) = 1) OR ((0,-1) = 1) OR ((0,1) = 1) OR ((1,-1) = 1) OR ((1,0) = 1) OR ((1,1) = 1) ) }
rule : { 1 + send(new_particle,1) } 20 { ((0,0) = 0) AND (trunc((0,-1)) = 2) AND (0.5  <= fractional((0,-1))) AND (fractional((0,-1)) < 0.75) AND (CELLPOS(0) != 15) AND ( ((-1,-1) = 1) OR ((-1,0) = 1) OR ((-1,1) = 1) OR ((0,-1) = 1) OR ((0,1) = 1) OR ((1,-1) = 1) OR ((1,0) = 1) OR ((1,1) = 1) ) }
rule : { 1 + send(new_particle,1) } 20 { ((0,0) = 0) AND (trunc((-1,0)) = 2) AND (0.75 <= fractional((-1,0))) AND (fractional((-1,0)) < 1    )                        AND ( ((-1,-1) = 1) OR ((-1,0) = 1) OR ((-1,1) = 1) OR ((0,-1) = 1) OR ((0,1) = 1) OR ((1,-1) = 1) OR ((1,0) = 1) OR ((1,1) = 1) ) }

rule : { 2 + random } 20 { ((0,0) = 0) AND (trunc((1,0))  = 2) AND (0     <= fractional((1,0)))  AND (fractional((1,0))  < 0.25) AND (CELLPOS(0) != 14) }
rule : { 2 + random } 20 { ((0,0) = 0) AND (trunc((0,1))  = 2) AND (0.25 <= fractional((0,1)))  AND (fractional((0,1))  < 0.5 ) AND (CELLPOS(0) != 15) }
rule : { 2 + random } 20 { ((0,0) = 0) AND (trunc((0,-1)) = 2) AND (0.5  <= fractional((0,-1))) AND (fractional((0,-1)) < 0.75) AND (CELLPOS(0) != 15) }
rule : { 2 + random } 20 { ((0,0) = 0) AND (trunc((-1,0)) = 2) AND (0.75 <= fractional((-1,0))) AND (fractional((-1,0)) < 1    ) }
